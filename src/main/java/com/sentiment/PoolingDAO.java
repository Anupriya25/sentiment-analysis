...
public class PoolingDAO 
{
   ...
   while(rs.next())
   {
	...
	public static int getpositivecount(String topic, String pos) {
		...
		sql = "SELECT COUNT(*) FROM m_tweets where college='"+topic+"' and detected_sentiment='"+pos+"'";
   ...
   while(rs.next())
   {
    ...
    int negcount=0;
		...
		sql = "SELECT COUNT(*) FROM m_tweets where college='"+topic+"' and detected_sentiment='"+neg+"'";
   ...
   while(rs.next())
   {
	...
	public static int getneuralcount(String topic, String neu) {
      int neucount=0;
		...
		sql = "SELECT COUNT(*) FROM m_tweets where college='"+topic+"' and detected_sentiment='"+neu+"'";
   ...
   while(rs.next())
   {
	...
	public static int getundecidablecount(String topic, String un) {
	      int neucount=0;
			...
			sql = "SELECT COUNT(*) FROM m_tweets where college='"+topic+"' and detected_sentiment='"+un+"'";
	...
	public static int gettotalcount(String topic) {
	      int neucount=0;
			...
			sql = "SELECT COUNT(*) FROM m_tweets where college='"+topic+"'";
