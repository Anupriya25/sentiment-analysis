...
<body>
 ...
 <form class="register active" action="<%=request.getContextPath()%>/Login" method="post">   
                ...
                <div class="col-md-8">
                    <div  id="contact-form" >
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="password" class="form-control" name="pass" id="email" placeholder="Your Password"  />
                          ...
                          <!--   <div class="col-md-12 form-group">
                            ...
                            <button type="submit" style="height: 40px; margin-bottom: 50px;" class="col-md-offset-4 col-md-4 btn btn-primary">Login</button>
...
%>
			<div class="error" id="message" style="position:absolute;top:600px;left:50px">
				...
				alert("User Logout Successfully");</script>
			</div>
<%
		}
		if(no==1)
...
%>
			<div class="error" id="message" style="position:absolute;top:600px;left:50px">
				...
				alert("Please enter username and password correctly");</script>
			</div>
<%
		}
...
%>
			<div class="error" id="message" style="position:absolute;top:600px;left:50px">
				...
				alert("Registration Successfull please login ");</script>
			</div>
<%
		}
