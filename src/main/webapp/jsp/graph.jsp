        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h1 data-scroll-reveal="enter from the bottom after 0.1s"><strong>3D Graph</strong></h1>
                    <p data-scroll-reveal="enter from the bottom after 0.2s"   style=" font-style:bold;   color:#2E8B57; font-size: 20px;">
                       You can check Your Graph
                    </p>
                    <form data-scroll-reveal="enter from the bottom after 0.3s" action="<%=request.getContextPath()%>/Barchart" method="get">
                    <input type="hidden" name="no" value="2"></input>
                        ...
                        <div class="form-group">
                           <!--  <a href="#hire-sec" class="btn btn-default ">CHANGE PASSWORD</a> -->
                            ...
                            <input type="submit" class="form-control"  value="Check Graph" style="background-color:#2E8B57" required="required" placeholder="Your Name" />
...
%>
			<div class="error" id="message" style="position:absolute;top:600px;left:50px">
				...
				alert("Graph is plotted successfully");</script>
			</div>
<%
		}
		if(no==3)
