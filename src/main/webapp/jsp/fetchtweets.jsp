            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <p data-scroll-reveal="enter from the bottom after 0.2s"   style=" font-style:bold;   color:#2E8B57; font-size: 20px;">
                      AT a time you can fetch 100 Tweets
                    </p>
                    <form data-scroll-reveal="enter from the bottom after 0.3s" action="<%=request.getContextPath() %>/Fetchtweets" method="get">
                    <input type="hidden" name="no" value="2"></input>
                  
                        <div class="form-group">
                        <label><font style="color: maroon;font-weight: bold;">Give Your Keyword</font></label>
                            <input type="text" class="form-control"  name="keyword"   required="required" placeholder="Please Give Your Keyword" />
                        </div>
                        
                        <div class="form-group">
                          
                            
                            <input type="submit" class="form-control"  value="Fetch Tweets" style="background-color:#2E8B57" required="required" placeholder="Your Name" />
