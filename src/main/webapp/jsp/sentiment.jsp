        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h1 data-scroll-reveal="enter from the bottom after 0.1s"><strong>Sentiment Process</strong></h1>
                    <p data-scroll-reveal="enter from the bottom after 0.2s"   style=" font-style:bold;   color:#2E8B57; font-size: 20px;">
                     Select college for sentiment process
                    </p>
                    <form data-scroll-reveal="enter from the bottom after 0.3s" action="<%=request.getContextPath() %>/Sentimentprocess" method="get">
                    <input type="hidden" name="no" value="2"></input>
                  
                        <div class="form-group">
                        <label><font style="color: maroon;font-weight: bold;">Select Your College</font></label>
              ...
              for(int i=0;i<data.size();i++)
            {
                 ...
                 <%  }%> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" class="form-control"  value="Sentiment process" style="background-color:#2E8B57" required="required" placeholder="Your Name" />
