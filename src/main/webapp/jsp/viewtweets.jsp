        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h1 data-scroll-reveal="enter from the bottom after 0.1s"><strong>Tweets from Twitter API</strong></h1>
                    <p data-scroll-reveal="enter from the bottom after 0.2s"   style=" font-style:bold;   color:#2E8B57; font-size: 20px;">
                      View tweets based on the keyword given
                    </p>
                    <form data-scroll-reveal="enter from the bottom after 0.3s" action="<%=request.getContextPath() %>/Viewtweets" method="get">
                    <input type="hidden" name="no" value="2"></input>
                  
                        <div class="form-group">
                        <label><font style="color: maroon;font-weight: bold;">Select Your Keyword</font></label>
                        
                        
                            <!-- <input type="text" class="form-control"  name="keyword"   required="required" placeholder="Select keyword from dropdownlist" /> -->
              ...
              for(int i=0;i<data.size();i++)
            {
                 ...
                 <%  }%> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" class="form-control"  value="View Tweets" style="background-color:#2E8B57" required="required" placeholder="Your Name" />
